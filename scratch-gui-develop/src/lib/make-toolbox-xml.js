...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    // Still computed for possible extension overrides but not included in final XML.
    ...
    // Build toolbox WITHOUT Motion, Looks, Sound, Control, Sensing categories.
    const everything = [
        xmlOpen,
        // motionXML, gap,      // REMOVED
        // looksXML, gap,       // REMOVED
        // soundXML, gap,       // REMOVED
        // controlXML, gap,     // REMOVED
        // sensingXML, gap,     // REMOVED
        eventsXML, gap,
        operatorsXML, gap,
        variablesXML, gap,
        myBlocksXML
